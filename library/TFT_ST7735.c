...
//RST ->PA11
#define PIN_TFT_RST_High()	GPIOA->BSRR = GPIO_Pin_11
#define PIN_TFT_RST_Low()	GPIOA->BRR  = GPIO_Pin_11
//DC  ->PA8
#define PIN_TFT_DC_Data()	GPIOA->BSRR = GPIO_Pin_8
#define PIN_TFT_DC_Cmd()	GPIOA->BRR  = GPIO_Pin_8
//CS  ->PA6
